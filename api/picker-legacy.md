...
URL: https://ionicframework.com/docs/api/picker-legacy

Version: v8
[scoped](/docs/reference/glossary#scoped)Deprecation Notice
`ion-picker-legacy` is deprecated and will be removed in the next major release. Migrate to [`ion-picker`](/docs/api/picker) as soon as possible.
