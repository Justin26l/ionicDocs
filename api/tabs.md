...
Version: v8
[shadow](/docs/reference/glossary#shadow)Tabs are a top level navigation component to implement a tab-based navigation. The component is a container of individual [Tab](/docs/api/tab) components.
...
Best Practices
Ionic has guides on best practices for routing patterns with tabs. Check out the guides for [Angular](/docs/angular/navigation#working-with-tabs) , [React](/docs/react/navigation#working-with-tabs) , and [Vue](/docs/vue/navigation#working-with-tabs) for additional information.
