...
URL: https://ionicframework.com/docs/api/router-outlet

Version: v8
[shadow](/docs/reference/glossary#shadow)The router outlet behaves in a similar way to Angular's built-in router outlet component and Vue's router view component, but contains the logic for providing a stacked navigation, and animating views in and out.
