...
URL: https://ionicframework.com/docs/api/input-password-toggle

Version: v8
[shadow](/docs/reference/glossary#shadow)The InputPasswordToggle component is a companion component to [Input](/docs/api/input) . It allows users to toggle the visibility of text in a password input.

## Basic Usage

info
InputPasswordToggle must be used with an [Input](/docs/api/input) that has its [`type`](/docs/api/input/#type) property set to either `'text'` or `'password'` .
