...
URL: https://ionicframework.com/docs/api/breadcrumb

Version: v8
[shadow](/docs/reference/glossary#shadow)A Breadcrumb is a single navigation item that is a child of the Breadcrumbs component. A breadcrumb can link elsewhere in an app or it can be plain text. Each breadcrumb has a separator between it and the next breadcrumb and can optionally contain an icon.

See the [Breadcrumbs](/docs/api/breadcrumbs) documentation for more information.
