...
URL: https://ionicframework.com/docs/api/router-link

Version: v8
[shadow](/docs/reference/glossary#shadow)The router link component is used for navigating to a specified link. Similar to the browser's anchor tag, it can accept a href for the location, and a direction for the transition animation.
...
See the [Router](/docs/api/router) documentation for more information.
