...
URL: https://ionicframework.com/docs/api/textarea

Version: v8
[scoped](/docs/reference/glossary#scoped)The textarea component is used for multi-line text input. A native textarea element is rendered inside of the component. The user experience and interactivity of the textarea component is improved by having control over the native textarea.
