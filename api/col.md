...
URL: https://ionicframework.com/docs/api/col

Version: v8
[shadow](/docs/reference/glossary#shadow)Columns are cellular components of the [grid](/docs/api/grid) system and go inside of a [row](/docs/api/row) . They will expand to fill the row. All content within a grid should go inside of a column.

See the [grid](/docs/api/grid) documentation for more information.
