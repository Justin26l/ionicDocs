...
URL: https://ionicframework.com/docs/api/input-otp

Version: v8
[scoped](/docs/reference/glossary#scoped)The Input OTP component is a specialized input component designed for entering one-time passwords (OTP). It provides a user-friendly interface for entering verification codes with support for multiple input boxes and automatic focus management.
...
| **Description** | Where separators should be shown between input boxes. Can be a comma-separated string or an array of numbers.
