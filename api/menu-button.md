...
URL: https://ionicframework.com/docs/api/menu-button

Version: v8
[shadow](/docs/reference/glossary#shadow)The Menu Button component contains an icon and automatically adds functionality to open a menu when clicked.

See the [menu](/docs/api/menu) documentation for more information.
