...
Version: v8
[shadow](/docs/reference/glossary#shadow)Card header is a child component of card that should be placed before the card content. It can contain a [card title](/docs/api/card-title) and a [card subtitle](/docs/api/card-subtitle) .
